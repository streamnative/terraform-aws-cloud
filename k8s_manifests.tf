# Applications CRD https://github.com/kubernetes-sigs/application
# Notes:
# - This CRD was generated with the tfk8s tool - https://github.com/jrhouston/tfk8s
# - You need to remove metadata.creationTimestamp from the generated CRD - https://github.com/hashicorp/terraform-provider-kubernetes/issues/1378
resource "kubernetes_manifest" "application_crd" {
  count = var.install_application_crd ? 1 : 0
  manifest = {
