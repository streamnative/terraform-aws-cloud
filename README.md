...
| <a name="input_private_subnet_ids"></a> [private\_subnet\_ids](#input\_private\_subnet\_ids) | The ids of existing private subnets. If the length is 0 or null, nodes will use public IP. | `list(string)` | `[]` | no |
