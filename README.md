...
| <a name="bootstrap_self_managed_addons"></a> [bootstrap\_self\_managed\_addons](#bootstrap\_self\_managed\_addons) | Indicates whether or not to bootstrap self-managed addons after the cluster has been created. | `bool` | `true` | no |
