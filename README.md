...
| <a name="input_service_domain"></a> [service\_domain](#input\_service\_domain) | The domain name being used by the environment, needed specifically for Istio's authorization policies. | `string` | n/a | yes |
